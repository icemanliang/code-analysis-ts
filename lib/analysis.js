...
const vue_parser = require('@vue/compiler-dom');                                                              //解析vue文件解析器
const ts = require('typescript');                                                                             //解析ts代码解析器
const chalk = require('chalk');                                                                               //美化输出
const ora = require('ora');                                                                                   //美化命令行交互
...
const { scoreDeal } = require(path.join(__dirname, './score'));                                               //代码评分操作
...
class CodeAnalysis {
  constructor(options) {
    ...
    this.isScanVue = options.isScanVue || false;                                      // 是否要扫描分析vue中的ts代码
